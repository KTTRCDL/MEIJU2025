...
class VariantMultimodalDataset(BaseDataset):
    @staticmethod
    def modify_commandline_options(parser):
        ...
        parser.add_argument('--feature_dirs', type=str, nargs='+', 
                            default=['datasets/MC-EIU_Track1_English_Processed/Features/wav2vec-large-c-FRA', 'datasets/MC-EIU_Track1_English_Processed/Features/manet_FRA', 'datasets/MC-EIU_Track1_English_Processed/Features/roberta-base-4-FRA'],
