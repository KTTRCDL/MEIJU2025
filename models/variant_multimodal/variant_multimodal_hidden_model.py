...
class VariantMultimodalHiddenModel(BaseModel):
    @staticmethod
    def modify_commandline_options(parser):
        ...
        parser.add_argument('--embed_dims', type=int, nargs='+', default=[256, 256, 256],
        ...
        parser.add_argument('--Transformer_head', type=int, default=8, help='head of fusion Transformer')
