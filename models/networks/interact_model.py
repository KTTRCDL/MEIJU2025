...
class InteractModule(Module):
    def __init__(self, opt):
        ...
        self.inter_attention = MultiheadAttention(embed_dim=opt.hidden_size, num_heads=1,
                                                  dropout=0)
        self.hence_attention = MultiheadAttention(embed_dim=opt.hidden_size, num_heads=1,
                                                  dropout=0)
